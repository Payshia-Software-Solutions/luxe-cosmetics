...
// export default function BrandGrid() {
//   return (
//     <div className="max-w-7xl mx-auto px-4 min-h-lg sm:px-6 lg:px-8 py-10 mb-5">
//       <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-8">
//         Our Cosmetic Brands
//       </h2>
...
//             <div className="p-4 border rounded-lg shadow-md bg-white dark:bg-[#fff0e9] flex flex-col items-center">
//               <Image
//                 src={brand.logo}
//                 alt={brand.name}
