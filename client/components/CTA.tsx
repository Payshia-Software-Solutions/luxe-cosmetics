            ...
            <div className="p-8 md:p-12 lg:px-16 lg:py-24">
                <div className="mx-auto max-w-lg text-center">
                    ...
                    <p className="hidden text-gray-500 sm:mt-4 sm:block">
                        Experience the glow of healthy, nourished skin with our range of expertly crafted skincare products. Powered by natural ingredients and advanced science, we offer solutions to brighten, hydrate, and protect your skin. Reveal your natural radiance with every use.
                    </p>
                </div>
